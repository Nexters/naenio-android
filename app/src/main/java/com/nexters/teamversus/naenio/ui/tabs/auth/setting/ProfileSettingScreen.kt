...
import com.nexters.teamversus.naenio.ui.tabs.auth.model.ProfileImageModel
...
fun ProfileSettingTopBar(
    ...
    Row(
        ...
        Text(
            ...
            text = stringResource(id = com.nexters.teamversus.naenio.R.string.set_profile),
        ...
        Text(
            ...
            text = stringResource(id = com.nexters.teamversus.naenio.R.string.save),
...
fun ProfileImage(
    ...
    Box(
        ...
        Image(
            ...
            painter = painterResource(id = com.nexters.teamversus.naenio.R.drawable.ic_edit_pan),
            contentDescription = ""
        )
    }
}
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    ...
                    painter = painterResource(id = com.nexters.teamversus.naenio.R.drawable.ic_close),
                    contentDescription = ""
                )
            }
            Spacer(
